...
def main():
    ...
    try:
        ...
        bp_params = {"name": "PhysicsObstacleBP", "parent_class": "Actor"}
        ...
        function_params = {
            ...
            "params": {
                "Torque": [
                    ...
                    0,
                    100.0,
                ],  # This should be connected to the RotationSpeed variable
                "BoneName": "None",
                "bAccelChange": True,
            },
        ...
        compile_params = {"blueprint_name": "PhysicsObstacleBP"}
        ...
        logger.info(
            "The obstacles should start rotating due to the Tick event connection"
        )
