...
def register_blueprint_tools(mcp: FastMCP):
    ...
    def set_blueprint_property(
        ctx: Context, blueprint_name: str, property_name: str, property_value
    ) -> Dict[str, Any]:
        """
    ...
    def set_pawn_properties(
        ...
        try:
            ...
            if use_controller_rotation_pitch is not None:
                properties["bUseControllerRotationPitch"] = (
            ...
            if not properties:
                ...
                return {
                    "success": True,
                    "message": "No properties specified to set",
                    "results": {},
                }
            ...
            return {
                ...
                "message": (
                    "Pawn properties set"
                    if overall_success
                    else "Some pawn properties failed to set"
                ),
                "results": results,
            }
